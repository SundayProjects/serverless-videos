...
exports.handler = function(event, context, callback){
    ...
    //todo eval if user is authenticated
    var encryptedkey = event.Records[0].s3.object.key;//todo read properly
    var decryptedkey = decrypt(encryptedkey);
    callback(null, 'Added URL' + decryptedkey);//todo return properly
    ...
    //database.child('videos').child(encrypt(uniqueVideoKey)).set({
    //    transcoding: false,
    //    source: videoUrl
    //})
    //.then(function(){
